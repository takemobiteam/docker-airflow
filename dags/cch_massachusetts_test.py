"""
Submit an AWS batch job for massachusetts in testing
"""
...
jobNamePrefix = 'cch_map_update_airflow_massachusetts_test_'
...
dag = DAG("cch_massachusetts_test", default_args=default_args, catchup=False, schedule_interval="0 * * * *",)
